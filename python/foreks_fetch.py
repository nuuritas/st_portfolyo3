...
all_data_daily['date'] = pd.to_datetime(all_data_daily['d'], unit='ms').dt.tz_localize('UTC').dt.tz_convert('Europe/Istanbul')
...
all_data_hourly["date"] = pd.to_datetime(all_data_hourly["d"], unit='ms').dt.tz_localize('UTC').dt.tz_convert('Europe/Istanbul')
